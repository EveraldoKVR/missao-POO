...
clt = FuncionarioCLT('João', 3000.0)
pj = FuncionarioPJ('Maria ', 160, 25.0)
print(f'Pagamento CLT: {clt.nome} R${clt.calcular_pagamento():.2f}')
print(f'Pagamento PJ: {pj.nome} R${pj.calcular_pagamento():.2f}')